import java.util.Scanner;
  ...
  public class chatbotfinal {
      ...
      public static void main(String[] args) {
          ...
          if(random==0){
              System.out.println("Greetings! I am your Pizza Palace informational bot. Would you like to know about the menu or the times that we are open? If you want to stop, type bye");
          }
          ...
          while(bye==false){
              ...
              if (userResp.toLowerCase().contains("meat lovers")) {
